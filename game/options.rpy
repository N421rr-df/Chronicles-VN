define config.mouse = {
    "default": [
        ("gui/cursor/cursor_default.cur", 0, 0)
    ]
}
...
define config.name = _("Chronicles VN")
...
define build.name = "ChroniclesVN"
...
define config.main_menu_music = "audio/music/main_menu_theme.mp3"
...
define config.save_directory = "ChroniclesVN-1785528708"
